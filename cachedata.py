...
class IBDataCache(object):
    ...
    def _reset_data(self, host='127.0.0.1', port=7497, client_id=None):
    ...
    def __init__(self, data_path='/docker_stocks/data', date_format='%Y%m%d %H:%M:%S', host='127.0.0.1', port=7497, client_id=None):
...
if __name__ == '__main__':
    ...
    df = downloader.get_dataframe(**stock_kwargs, timeoutsecs=10)
    print(df)
